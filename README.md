...
interpret or validate the string, it's passed straight through, so any
syntax Excel itself accepts works here. Excel's 256-character limit on
the combined string (including control characters) isn't checked at
